...
public class 2KeysKeyboard {
    ...
    public int minSteps(int buffer, int numSteps, int currNum, int goal){
        ...
        int left = minSteps(buffer, numSteps+1, currNum+buffer, goal);
        int right = minSteps(currNum, numSteps+2, currNum*2, goal);
